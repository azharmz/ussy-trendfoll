...
create table if not exists positions (
    ...
    entry_price numeric not null,          -- close hari sinyal (match backtest, apple-to-apple)
    realistic_entry_price numeric,          -- open hari BERIKUTNYA (realistis, terisi 1 hari setelah entry_date)
