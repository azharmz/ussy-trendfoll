"""Research-only FSE-007 benchmark readiness contract.

This module does not alter production. It defines the minimum freshness rule
required by the actual decision semantics:
